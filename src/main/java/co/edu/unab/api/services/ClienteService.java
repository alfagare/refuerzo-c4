...
public class ClienteService {
    ...
    public ArrayList<ClienteModel> obtenerPorCiudadYDepartamento(String ciudad, String departamento){
...
//        return clientesService.obtenerClientesMayorIgualPuntos(puntos);
//    }
